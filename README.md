...
64位:HwidGetCurrentEx(unsigned __int8 *key, int pid2, struct _HWID **struct_HWID, unsigned int *byte, int **a5, unsigned int *a6)
32位:HwidGetCurrentEx(unsigned __int8 *, unsigned int, struct _HWID **, unsigned int *, int **, unsigned int *)
